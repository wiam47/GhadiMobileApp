package com.example.ghadidelivery.Adapters
...
import com.example.ghadidelivery.R
...
class IntroSliderAdapter(private val introSlide: List<IntroSlide>)
    ...
    inner class IntroSlideViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val textTitle = view.findViewById<TextView>(R.id.titleTxtV)
        private val textDescription = view.findViewById<TextView>(R.id.descrTxtV)
